  ...
  return (
    <div className="space-y-4">
      ...
      {!config && state.status !== 'error' && (
        <div className="cc-card p-10 text-center text-sm text-t3" role="status"><Loader2 className="w-4 h-4 animate-spin inline mr-2" /> Building preview/export config…</div>
      )}
