...
const FEATURES: Feature[] = [
  ...
  { phase: 1, name: 'Integration Hub foundation', models: ['Integration', 'IntegrationRunLog'], routes: ["'/tenants/:tenantId/providers'"], pages: ['PlatformConsole.tsx'], userFacing: false, note: 'operator-only since 2026-08-30: the tenant grid, its Mock Mode badges and its Test-connection buttons moved to the Platform Console. A clinic reads a capability instead ("Card payments: not set up") from GET /v1/capabilities.' },
