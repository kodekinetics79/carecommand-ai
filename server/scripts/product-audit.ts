...
const FEATURES: Feature[] = [
  ...
  { phase: 1, name: 'CRM campaign / reactivation engine', models: ['Campaign', 'Lead'], routes: ["'/campaigns'", "'/leads'"], pages: ['Campaigner.tsx', 'CRM.tsx'], userFacing: true },
  ...
  { phase: 3, name: 'AI campaign generator', models: ['Campaign'], routes: ["'/generateCampaign'"], pages: ['Campaigner.tsx'], userFacing: true, note: 'campaign CRUD exists; no AI generation' },
  { phase: 3, name: 'AI denial-prevention assistant', models: ['EligibilityVerification'], pages: ['DenialAssistant.tsx'], userFacing: true, note: 'eligibility data only' },
